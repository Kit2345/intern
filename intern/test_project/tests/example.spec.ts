...
test("login and download", async ({ browser }) => {
  ...
  await page.goto("https://intern-kappa-seven.vercel.app/login");
  ...
  await page.goto("https://intern-kappa-seven.vercel.app/");
  ...
  const engagementLoggerBoxExists = await page.isVisible(
    "selector-for-EngagementLoggerBox"
  );
